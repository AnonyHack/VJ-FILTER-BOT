...
BOT_TOKEN = environ.get('BOT_TOKEN', "8162412397:AAHH_xYzB9uSnNBuRDg1hk_LNaaatCEO9N0")
...
# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5962658076').split()] # For Multiple Id Use One Space Between Each.
...
auth_channel = environ.get('AUTH_CHANNEL', '-1002480139306') # give your force subscribe channel id here else leave it blank
...
DATABASE_NAME = environ.get('DATABASE_NAME', "MovieHubFilter")
...
CHNL_LNK = environ.get('CHNL_LNK', 'https://t.me/Megahubbots')
SUPPORT_CHAT = environ.get('SUPPORT_CHAT', 'Free_VPN_Chats') # Support Chat Link Without https:// or @
