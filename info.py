...
PICS = (environ.get('PICS', 'https://files.fm/u/97vmdw8jku#/view/m8uamn8mbw')).split()


# Admins & Users
ADMINS = [int(admin) if id_pattern.search(admin) else admin for admin in environ.get('ADMINS', '5962658076 6211392720 5824797119 5723483216').split()] # For Multiple Id Use One Space Between Each.
